...
MIN_CONF_G0 = 0.80      # (ajustado) confiança mínima do top1
MIN_GAP_G0  = 0.12      # (ajustado) distância top1 - top2
MIN_SAMPLES = 1500      # (ajustado) libera FIRE com ~1.5k amostras
...
# =========================
# Limiar e segurança
IA2_TIER_STRICT             = 0.80  # (ajustado) % mínima para FIRE
IA2_GAP_SAFETY              = 0.12  # (ajustado) gap top1-top2
IA2_DELTA_GAP               = 0.02  # (ajustado) tolerância
...
def _relevance_ok(conf_raw: float, gap: float, tail_len: int) -> bool:
    # Regra: FIRE se conf ≥ 80% OU (conf ≥ 78% e gap ≥ 0.12), e com base suficiente
